...
function openDelegation(){ wizardStep=1; wizard={type:"discount",name:"Duyệt giảm giá khách hàng hiện hữu",frequency:"50",problem:"Gần như lần nào cũng phải chờ Giám đốc",goal:"Giảm ít nhất 70% đề xuất CEO phải duyệt",recipient:"Thu Hà · Trưởng phòng Kinh doanh",backup:"",scope:"Khách hàng hiện hữu · Sản phẩm A & B · Miền Bắc",outOfScope:"Khách hàng mới, hợp đồng đặc biệt",selfMax:"8",consultMax:"12",special:"Khách hàng chiến lược; công nợ quá hạn; thay đổi điều khoản thanh toán",knowledge:"Chính sách giá V3 + Checklist",start:"01/10/2026",review:"01/11/2026"}; renderWizard(); const dialog=$("#delegationDialog"); dialog.showModal(); animateDialog(dialog); }
function renderWizard(){
  ...
  const pages={
    ...
    3:`<div class="form-block"><h3>Phạm vi nào được giao?</h3><p>Viết rõ cả điều kiện được xử lý và các trường hợp bắt buộc phải chuyển cấp.</p><div class="field"><label>Phạm vi áp dụng</label><textarea data-w="scope">${escapeHTML(wizard.scope)}</textarea><span class="hint">Ví dụ: khách hàng hiện hữu, sản phẩm A & B, khu vực miền Bắc.</span></div><div class="field" style="margin-top:14px"><label>Ngoài phạm vi <span class="optional-label">(có thể chỉnh sửa)</span></label><input data-w="outOfScope" value="${escapeHTML(wizard.outOfScope)}" placeholder="Ví dụ: khách hàng mới, hợp đồng đặc biệt" /><span class="hint">Các trường hợp này sẽ không thuộc quyền tự xử lý của người nhận.</span></div></div>`,
